    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.DateField()),
                ('Category', multiselectfield.db.fields.MultiSelectField(choices=[('absent', 'absent'), ('present', 'present')], max_length=14)),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main_app.course')),
        ...
        migrations.CreateModel(
            name='list_exp',
            fields=[
                ('exp_no', models.IntegerField(primary_key=True, serialize=False)),
                ('max_marks', models.IntegerField()),
                ('secured_marks', models.IntegerField()),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main_app.student')),
                ('sub_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main_app.subject')),
            ],
        ),
        migrations.CreateModel(
