...
urlpatterns = [
    ...
    path('staff/list/', staff_views.list_form,
        name='list'),
    path('staff/sea/', staff_views.sea,
        name='sea_atd'),
     path("exp/delete/<int:e_id>",
         staff_views.delete_Exp, name='delete_exp'),
    ...
    path('student/view/search_but/', staff_views.search_but,
         ...
         name='search_stud'),
         path('student/view/sea/', staff_views.sea,
         name='search_atd'),
    path('student/view/Add/', student_views.stud_form,
        name='Add'),
     path('student/expp', student_views.ie_exp,
        name='expp'),  
     path('student/view/edit/', hod_views.edit_form,
        name='edit'),  
     path('student/exp/', staff_views.vie_exp,
        name='exp'),
